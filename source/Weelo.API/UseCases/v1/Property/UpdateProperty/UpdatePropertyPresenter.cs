namespace Weelo.API.UseCases.v1.Property.UpdateProperty
{
    ...
    public sealed class UpdatePropertyPresenter : IOutputPort
    {
        ...
        private readonly ILogger<UpdatePropertyPresenter> _logger;

        public UpdatePropertyPresenter(ILogger<UpdatePropertyPresenter> logger)
        {
            _logger = logger;
        }
        ...
        public void Default(UpdatePropertyOutput output, string message)
        {
