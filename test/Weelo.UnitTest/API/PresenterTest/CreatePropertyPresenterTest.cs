namespace Weelo.UnitTest.API.PresenterTests
{
    ...
    public class CreatePropertyPresenterTest
    {
        private object result;
        CreatePropertyOutput output;

        Mock<ILogger<CreatePropertyPresenter>> loggerMock;
        CreatePropertyPresenter presenterMock;
        ...
        public void SetUp()
        {
            ...
            output = new CreatePropertyOutput(result);
            loggerMock = new Mock<ILogger<CreatePropertyPresenter>>(); 
        }
        ...
        {
            // Arrange
            var presenter = new CreatePropertyPresenter(loggerMock.Object);
